...
Using https://linkml.io/linkml/schemas/uris-and-mappings.html#class-uri-and-slot-uri[class and slot URIs] in particular, you can reference existing definitions in xref::terms_and_defs.adoc#ontology[ontologies] to indicate -- and standardize -- the meaning of your data.
